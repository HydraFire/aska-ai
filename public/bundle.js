...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pushNotification__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__speechSynthesizer__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__functions_functionStart__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__graphics_animation_Kaleidoscope__ = __webpack_require__(22);
...
function send(data, type) {
  if (data !== '') {
    ...
    if (type === 'upload') {
      ...
      __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logC('socket.send(string)');
...
function start(ip) {
  ...
  socket.onopen = function onopen() {
    __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logC('SOCKET CONNECT');
  ...
  socket.onmessage = function onmessage(event) {
    ...
    switch (message.type) {
      case 'aska':
        Object(__WEBPACK_IMPORTED_MODULE_2__speechSynthesizer__["a" /* default */])(message.data);
        break;
      case 'clientFunction':
        Object(__WEBPACK_IMPORTED_MODULE_3__functions_functionStart__["a" /* default */])(message.data);
        break;
      /*
      ...
      */
      case 'token':
        ...
        __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logS('TOKEN is accepted');
        break;
      case 'music':
      ...
      case 'getImgsKaleidos':
        Object(__WEBPACK_IMPORTED_MODULE_4__graphics_animation_Kaleidoscope__["b" /* newImagesLoad */])(message.data);
        break;
      case 'goToUrl':
        goToUrl(message.data);
        break;
      default:
        __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logS(message.data);
        break;
    }
  };
  // ////////////////////////// SOCKET CLIENT /////////////////////////////////////
  ...
  socket.onclose = function onclose(event) {
    ...
    if (event.wasClean) {
      __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logCE('Соединение закрыто чисто');
    } else {
      __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logCE('Обрыв соединения'); // например, "убит" процесс сервера
    }
    __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logCE(`Код: ${event.code} причина: ${event.reason}`);
  };
}

/* harmony default export */ __webpack_exports__["a"] = ({ start, send });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return speechRec; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return startStopRec; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return recStop; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return recStart; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__webSocketClient__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interface_displayWordsClass__ = __webpack_require__(21);
...
function recStart() {
  __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logC('recognition.start()');
  recognition.start();
  statusRec = true;
  recognition.addEventListener('end', recognition.start);
}
function recStop() {
  __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logC('recognition.stop()');
...
function speechRec() {
  ...
  const display = new __WEBPACK_IMPORTED_MODULE_2__interface_displayWordsClass__["a" /* default */]();
  ...
  */
  function sendWordsFinal() {
    ...
    // Отправляем сокеты.
    __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send(text);
  }
  function waiting() {
    i = 0;
    if (!waitForSend) {
      ...
      const m = setInterval(() => {
        i += 1;
        if (i > 2) {
          __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__["a" /* default */].logC('sendWordsFinal()');
          sendWordsFinal();
        }
        if (waitInterval) {
          clearInterval(m);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_web_audio_analyser__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_web_audio_analyser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_web_audio_analyser__);
// WebAudioAnalyser
...
function analyserGetReady() {
  ...
  const analyser = __WEBPACK_IMPORTED_MODULE_0_web_audio_analyser___default()(audio);
  return analyser;
}

/* harmony default export */ __webpack_exports__["a"] = (analyserGetReady);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__webSocketClient__ = __webpack_require__(6);
...
function subscribeUserToPush() {
  return navigator.serviceWorker.register('service-worker.js').then(function (registration) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__webSocketClient__["a" /* default */].send(JSON.stringify(pushSubscription), 'notificationSetKey');
...
function sendSocketToGetPublicKey() {
  __WEBPACK_IMPORTED_MODULE_0__webSocketClient__["a" /* default */].send('doNotMatter', 'notificationGetKey');
}
...
/* unused harmony default export */ var _unused_webpack_default_export = ({ subscribeBS, setVapidPublicKey });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_blueimp_md5__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__interface_iconsole__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__webSocketClient__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__speechRecognition__ = __webpack_require__(13);





let aska_yandex_id = "222499e2-1e45-4b6d-aaaa-70b53b87c2ec";

function getServerUrl() {
  if (localStorage.aska_ip) {
    return `https://${localStorage.aska_ip.split('//')[1]}/sample/`;
  }
  return `https://${"ws://localhost:8080".split('//')[1]}/sample/`;
}
/* eslint-disable */
function aska(text) {
  ...
  function choseAudioTag(text, audioTag, num) {
    ...
    function createURL(text) {
      if (text == '20Hz') {
        ...
        console.log(text);
        return `${getServerUrl()}${__WEBPACK_IMPORTED_MODULE_0_blueimp_md5___default()(text.substring(1, text.length))}.mp3`;
      } else {
    ...
    function playAudio(text) {
      ...
      audioTag.onloadeddata = function onloadeddata() {
        __WEBPACK_IMPORTED_MODULE_1__interface_iconsole__["a" /* default */].logC('audioTag.play()');
        audioTag.play();
        __WEBPACK_IMPORTED_MODULE_2__webSocketClient__["a" /* default */].send('speech_start', 'AUDIO');
        Object(__WEBPACK_IMPORTED_MODULE_3__speechRecognition__["b" /* recStop */])();
      };
    };
    ...
    function splitAndPlay(text) {
      ...
      if (text.length == 0) {
        audioTag.addEventListener('pause', () => {
          ...
          Object(__WEBPACK_IMPORTED_MODULE_3__speechRecognition__["a" /* recStart */])();
        }, { once: true });
      }
      return text;
    }
...
/* harmony default export */ __webpack_exports__["a"] = (aska);
...
/* harmony default export */ __webpack_exports__["a"] = (displayWordsClass);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Kaleidoscope; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return newImagesLoad; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__audioAnalyser__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__webSocketClient__ = __webpack_require__(6);
...
function loadImages() {
  __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send('lol', 'kaleidoscopeImg');
}
...
function Kaleidoscope() {
  const analyser = Object(__WEBPACK_IMPORTED_MODULE_0__audioAnalyser__["a" /* default */])();
...
Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"])(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_App__["a" /* default */], null), document.querySelector('#main'));
...
*/
var aa=__webpack_require__(4),ca=__webpack_require__(0),m=__webpack_require__(15),p=__webpack_require__(8),v=__webpack_require__(5),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ha=__webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__interface_header__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interface_logotype__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__interface_inputCommandLine__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__interface_sliderAudioVolume__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__interface_iconsoleUI__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__interface_iconsole__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__interface_music__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__interface_InteractWindow__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__css_app_css__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__css_app_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__css_app_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__graphics_graphicsStart__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__webSocketClient__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__speechRecognition__ = __webpack_require__(13);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  constructor() {
    ...
    this.chooseYourDestiny = e => {
      this.setState({ interactWindow: false });
      Object(__WEBPACK_IMPORTED_MODULE_10__graphics_graphicsStart__["a" /* default */])(e.target.value);
      __WEBPACK_IMPORTED_MODULE_11__webSocketClient__["a" /* default */].start("ws://localhost:8080");
      Object(__WEBPACK_IMPORTED_MODULE_12__speechRecognition__["c" /* speechRec */])();
    };
    ...
    this.renderW = () => {
      if (this.state.interactWindow) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8__interface_InteractWindow__["a" /* default */], { arr: ['shaderCloud', 'shaderSpace', 'shaderFractal00', 'shaderFractal01', 'shaderTemple', 'Equalizer', 'Kaleidoscope', 'Anime'], metod: this.chooseYourDestiny });
      } else {
        return '';
      }
    };
  ...
  componentDidMount() {
    __WEBPACK_IMPORTED_MODULE_6__interface_iconsole__["a" /* default */].start();
  }
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      null,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__interface_header__["a" /* default */], null),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'underCanvas' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__interface_logotype__["a" /* default */], null),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__interface_sliderAudioVolume__["a" /* default */], null),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__interface_iconsoleUI__["a" /* default */], { logType: 'serverLog' }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__interface_iconsoleUI__["a" /* default */], { logType: 'clientLog' })
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('canvas', { onClick: this.resize, id: 'draw' }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__interface_inputCommandLine__["a" /* default */], null),
      this.renderW(),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__interface_music__["a" /* default */], { ref: musicPlayer => {
          window.musicPlayer = musicPlayer;
        } }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('audio', { src: '', id: 'audio' }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('audio', { src: '', id: 'audio2' })
    );
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pushNotification__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_header_css__ = __webpack_require__(41);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__readClipboard__ = __webpack_require__(39);


const functionType = function functionType(type) {
  switch (type) {
    case 'read':
      Object(__WEBPACK_IMPORTED_MODULE_0__readClipboard__["a" /* read */])();
      break;
    case 'translate':
      Object(__WEBPACK_IMPORTED_MODULE_0__readClipboard__["b" /* translate */])();
      break;
    default:
      break;
  }
};
/* harmony default export */ __webpack_exports__["a"] = (functionType);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return read; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__speechSynthesizer__ = __webpack_require__(20);

/* eslint-disable */
const read = function read() {
  let extensionId = localStorage.askaChromeExtensionID;
  chrome.runtime.sendMessage(extensionId, { method: 'getClipboard' }, function (response) {
    Object(__WEBPACK_IMPORTED_MODULE_0__speechSynthesizer__["a" /* default */])(response);
  });
};
// /////////////////////////////////////////////////////////////////////////////
const translate = function translate() {
  ...
  chrome.runtime.sendMessage(extensionId, { method: 'getClipboard' }, function (response) {
    ...
    x.onload = function () {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0__speechSynthesizer__["a" /* default */])(n);
    };
    x.send(null);
  });
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__speechRecognition__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_logotype_css__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_logotype_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_logotype_css__);
...
function hendler() {
  ...
  logo.addEventListener('click', e => {
    if (microphoneOFF) {
      ...
      microphoneOFF = false;
      Object(__WEBPACK_IMPORTED_MODULE_1__speechRecognition__["d" /* startStopRec */])();
    } else {
...
// ///////////////////////////////////////////////////////////////////////////
class Logotype extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  componentDidMount() {
    hendler();
  }
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'words' })
    );
  }
}
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./logotype.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./logotype.css");
...
// module
exports.push([module.i, "/* Контейнер поверх Канваса с шейдером */\r\n#main_container{\r\n  text-align: center;\r\n  margin: 0px 0px 0px 0px;\r\n  z-index: 5;\r\n  width: 100%;\r\n  position: absolute;\r\n}\r\n#projectName{\r\n  -moz-user-select: none;\r\n  -khtml-user-select: none;\r\n  -webkit-user-select: none;\r\n  user-select: none;\r\n  height:120px;\r\n  padding-top:50px;\r\n  color:rgba(50, 50, 50, 1);\r\n  font-size: 90pt;\r\n}\r\n/* Отображение разпознаных слов */\r\n.words {\r\n  font-family: 'Exo 2', sans-serif;\r\n  width:100%;\r\n  color: rgba(0, 0, 0, 0.5);\r\n  line-height:2rem;\r\n}\r\np {\r\n  font-family: 'Jura', sans-serif;\r\n  margin: 0;\r\n}\r\n.words:before {\r\n  content: '';\r\n  position: absolute;\r\n  width: 4px;\r\n  top: 0;\r\n  left: 30px;\r\n  bottom: 0;\r\n}\r\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__webSocketClient__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__displayWordsClass__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_inputCommandLine_css__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_inputCommandLine_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__css_inputCommandLine_css__);
...
function hendler() {
  ...
  const display = new __WEBPACK_IMPORTED_MODULE_2__displayWordsClass__["a" /* default */]();
  ...
  function secondConnect(text) {
    ...
    if (isconnect === 'connect') {
      ...
      __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].start(`wss://${ip}`);
    } else {
      __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send(text);
    }
  }
    ...
    if (e.keyCode === 13) {
      if (this.value !== '') {
        ...
        if (this.value.includes('nightmare')) {
          __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send(this.value, 'code');
        } else {
          __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send(this.value, 'aska');
        }
        this.value = '';
        i = 0;
      }
...
class InputCommandLine extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  componentDidMount() {
    hendler();
  }
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'inputCommandLine', autoFocus: true, type: 'text', placeholder: '' }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'inputTab' },
        'Press Enter \u23CE'
...
/* harmony default export */ __webpack_exports__["a"] = (InputCommandLine);
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./inputCommandLine.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./inputCommandLine.css");
...
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Jura);", ""]);

// module
exports.push([module.i, ".inputConteiner {\r\n  padding: 0px;\r\n  margin-top: -4px;\r\n}\r\n.inputCommandLine {\r\n  width: 70%;\r\n  height: 22px;\r\n  font-size: 14px;\r\n  line-height: 22px;\r\n  vertical-align: middle;\r\n  float: left;\r\n  padding: 0px;\r\n  margin: 0px;\r\n  border-top: 0px;\r\n  border-left: 0px;\r\n  border-right: 0px;\r\n  color: #ddd;\r\n  border-color: rgb(22, 22, 22);\r\n  background: rgba(50, 50, 50, 1);\r\n  font-family: 'Jura', sans-serif;\r\n}\r\n.inputCommandLine:focus {\r\n  outline:0;\r\n}\r\n.inputTab {\r\n  -moz-user-select: none;\r\n  -khtml-user-select: none;\r\n  -webkit-user-select: none;\r\n  user-select: none;\r\n  width: 15%;\r\n  height: 22px;\r\n  font-size: 8px;\r\n  float: left;\r\n  line-height: 22px;\r\n  vertical-align: middle;\r\n  text-align: center;\r\n  color: #777;\r\n  background: rgba(22, 22, 22, 1);\r\n  font-family: 'Press Start 2P', cursive;\r\n}\r\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_sliderAudioVolume_css__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_sliderAudioVolume_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__css_sliderAudioVolume_css__);
...
class sliderAudioVolume extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	componentDidMount() {
		start();
	}
	render() {
...
/* harmony default export */ __webpack_exports__["a"] = (sliderAudioVolume);
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./sliderAudioVolume.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./sliderAudioVolume.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_iconsoleUI_css__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_iconsoleUI_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_iconsoleUI_css__);




class serverLog extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      null,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: this.props.logType })
    );
  }
}
serverLog.propTypes = {
  logType: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired
};
/* harmony default export */ __webpack_exports__["a"] = (serverLog);
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./iconsoleUI.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./iconsoleUI.css");
...
// module
exports.push([module.i, ".serverLog {\r\n margin: 65px 0px 0px 50px;\r\n position: absolute;\r\n font-size: 10px;\r\n font-family: 'Exo 2', sans-serif;\r\n color: #333;\r\n}\r\n.clientLog {\r\n margin: 65px 10px 0px 0px;\r\n float: right;\r\n text-align: right;\r\n font-size: 10px;\r\n font-family: 'Exo 2', sans-serif;\r\n color: #333;\r\n}\r\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__webSocketClient__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__iconsole__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_music_css__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_music_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__css_music_css__);
...
function init() {
  function FileSelectHandler(file) {
    //e.preventDefault()
    __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send({ type: 'uploadName', data: file.name }, 'music');
    __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send(file, 'upload');
  }
  ...
  function handleFileSelect(evt) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send({ type: 'uploadEnd' }, 'music');
    __WEBPACK_IMPORTED_MODULE_2__iconsole__["a" /* default */].logC('<ul>' + output.join('') + '</ul>');
  }
...
class Music extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  constructor() {
    super();
    ...
    this.endedTrack = () => {
      __WEBPACK_IMPORTED_MODULE_1__webSocketClient__["a" /* default */].send({ type: 'ended', track: this.state.playingTrack }, 'music');
    };
    ...
    this.alltagRender = () => {
      return this.state.playingTrack.allTag.map(v => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'button',
        { key: v, alt: v, onClick: this.allTagButton, className: 'tag_button' },
        v
      ));
    };

    this.tagRender = () => {
      return this.state.playingTrack.tag.map(v => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'button',
        { key: v, alt: v, onClick: this.tagButton, className: 'tag_button' },
        v
      ));
    };
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'music_main' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'music_first' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: 'music_name' },
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'button',
          { onClick: this.pause, className: 'music_button' },
          '\u25B7\u25FE'
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'button',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_interactWindow_css__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_interactWindow_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__css_interactWindow_css__);




class InteractWindow extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  constructor() {
    super();
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'interactWindow' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'interactWindow_bottom' },
        this.props.arr.map((v, i) => {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              'button',
              { value: v, alt: v, onClick: this.props.metod },
              v
            )
          );
        })
...
/* harmony default export */ __webpack_exports__["a"] = (InteractWindow);
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./interactWindow.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./interactWindow.css");
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = graphicsStart;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interface_iconsole__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__animation_Equalizer__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__animation_Kaleidoscope__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__animation_Anime__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shader_core__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shaders_shaderCloud__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shaders_shaderSpace__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shaders_shaderFractal00__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shaders_shaderFractal01__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shaders_shaderTemple__ = __webpack_require__(75);
...
function graphicsStart(value) {
  let lvl = 3;
  switch (value) {
    case 'shaderCloud':
      Object(__WEBPACK_IMPORTED_MODULE_4__shader_core__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_5__shaders_shaderCloud__["a" /* shaderCloud */], lvl);
      break;
    case 'shaderSpace':
      lvl = 2;
      Object(__WEBPACK_IMPORTED_MODULE_4__shader_core__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_6__shaders_shaderSpace__["a" /* shaderSpace */], lvl);
      break;
    case 'shaderFractal00':
      Object(__WEBPACK_IMPORTED_MODULE_4__shader_core__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_7__shaders_shaderFractal00__["a" /* shaderFractal00 */], lvl);
      break;
    case 'shaderFractal01':
      Object(__WEBPACK_IMPORTED_MODULE_4__shader_core__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_8__shaders_shaderFractal01__["a" /* shaderFractal01 */], lvl);
      break;
    case 'shaderTemple':
      Object(__WEBPACK_IMPORTED_MODULE_4__shader_core__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_9__shaders_shaderTemple__["a" /* shaderTemple */], lvl);
      break;
    case 'Equalizer':
      Object(__WEBPACK_IMPORTED_MODULE_1__animation_Equalizer__["a" /* default */])();
      break;
    case 'Kaleidoscope':
      Object(__WEBPACK_IMPORTED_MODULE_2__animation_Kaleidoscope__["a" /* Kaleidoscope */])();
      break;
    case 'Anime':
      Object(__WEBPACK_IMPORTED_MODULE_3__animation_Anime__["a" /* default */])();
      break;
    default:
      Object(__WEBPACK_IMPORTED_MODULE_1__animation_Equalizer__["a" /* default */])();
      break;
...
/* harmony default export */ __webpack_exports__["a"] = (canvasStart);
...
"use strict";
/* eslint-disable */
const shaderCloud = `precision mediump float;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = shaderCloud;
...
"use strict";
/* eslint-disable */
const shaderSpace = `precision highp float;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = shaderSpace;
...
"use strict";
/* eslint-disable */
const shaderFractal00 = `precision highp float;
...
float DE(in vec3 z)
{
    ...
    for (int n = 0; n < Iterations; n++) {
        z.xy = rotate(z.xy,4.0+2.0*cos( iTime/800.0));
        z = abs(z);
...
vec4 rayMarch(in vec3 from, in vec3 dir, in vec2 fragCoord) {
    ...
    float totalDistance = Jitter*rand(fragCoord.xy+vec2(iTime/10.0));
    vec3 dir2 = dir;
    float distance;
    int steps = 0;
    vec3 pos;
    for (int i=0; i < MaxSteps; i++) {
        ...
        dir.zy = rotate(dir2.zy,totalDistance*cos( iTime/400.0)*NonLinearPerspective);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = shaderFractal00;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = shaderFractal01;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = shaderTemple;
